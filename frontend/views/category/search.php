...
$currentCategory=$this->context->getCurrentCategory();
    ...
    $this->title = "Serach Result :: ".$searchdata['query'];
    ...
    <section class="hero">
         <div class="container">
            ...
            <div class="hero-content pb-5 text-center">
               <h1 class="hero-heading">Serach Result For <br />"<?= $searchdata['query'];?>"</h1> 
               <div class="row">
                  <div class="col-xl-8 offset-xl-2">
                     <p class="lead text-muted"><strong><?= $pages->totalCount;?></strong> products found.</p>
                  </div>
               </div>
            </div>
         </div>
